    ...
    <body>
        ...
        <div class="sidebar">
            ...
            <div class="dropdown-container">
                <a href="pesanruangan.php">Ruangan</a>
        ...
        <div class="main">
            <div class="container bg-dark" style="margin-top: 20px">
                <ul class="nav nav-pills nav-justified" id="pills-tab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active bg-dark text-light" id="transaksi-tab" data-toggle="pill" href="#pills-transaksi" role="tab" aria-controls="pills-transaksi" aria-selected="true">Transaksi</a>
                    </li>
                    <li class="nav-item">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <button type="submit" class="btn btn-primary" onclick="location.href='pesanstudiobs.php'">Ruangan</button>
                                        </div>
